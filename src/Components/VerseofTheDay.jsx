...
function VerseOfTheDay() {
  ...
  return (
 <Box sx={{height:{xs:"40%",lg:"40%",md:"30%"},width:{xs:"100%",lg:"90%"},backgroundColor:theme==="dark"?"rgb(37, 37, 37)":"white",margin:"1vmax 2vmax"
 ,padding:{lg:"20px 40px ",xs:"20px 2rem"},display:"flex",flexWrap:"wrap",borderRadius:"1.5vmax",boxShadow:"5px 10px 15px rgba(1, 0, 0, 0.3)",
alignItems:"center",

 }} >
<Typography variant='h2'component="h2" sx={{color:'#F57903',fontSize:{lg:"1.7vmax",xs:"5vmax"},
padding:{lg:"20px 30px ",xs:"20px 2rem"}}}>Verse Of The Day</Typography>
<Typography variant="body1" sx={{color:"grey",marginTop:"1vmax",
